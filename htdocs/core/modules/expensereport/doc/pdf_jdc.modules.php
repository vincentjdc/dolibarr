 ...
 */
class pdf_jdc extends ModeleExpenseReport
{
	 /**
	...
	public function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "";
		$this->description = $langs->trans('PDF£JDCExpenseReports');
		...
		*/
		...
		if ($showaddress) {
			...
			if (empty($conf->global->MAIN_INVERT_SENDER_RECIPIENT)) {
				...
				$pdf->MultiCell(80, 4, $outputlangs->convToOutputCharset($this->emetteur->label), 0, 'L');
